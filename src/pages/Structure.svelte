...
<Hero>
  ...
  >
    ...
    <p class="mb-8 leading-relaxed text-lg sm:text-2xl">
      The role of the Party's National Chairman is often different from a party
...
<GalleryBlock>
  ...
  <p class="lg:w-2/3 mx-auto leading-relaxed text-base" slot="gallery-subtitle">
    Whatever cardigan tote bag tumblr The ADP Board of Trustee (BoT) is a
...
<GalleryBlock>
  ...
  <p class="lg:w-2/3 mx-auto leading-relaxed text-base" slot="gallery-subtitle">
    The ADP National Working Committee Members also known as NWC, is the
