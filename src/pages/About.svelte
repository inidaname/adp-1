...
<Hero>
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6" slot="hero-image">
      ...
      <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center" slot="hero-texts">
        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-red-500">About ADP</h1>
...
<section class="container mx-auto">
    <div class="p-4">
   <h2 class=" py-5 font-medium title-font sm:text-3xl text-2xl text-blue-900 text-left ">ADP's Three Points Agenda</h2>  
   <p class="font-medium py-2">
In the ADP, the three point agenda are:
   </p>

<ul class="list-disc px-7">
    <li>All Inclusiveness</li>
    <li>Democracy Empowerment of the Youth and Women</li>
    <li>Party Supremacy</li>
</ul>
<p class="py-4">The keyword is democracy and this democracy is the same that is universally accepted and practiced all over; no one man or woman is greater than the party or one's view much better than the other member's when that view has not been examined and discussed. The ADP is the Nigeria's credible alternative with modern thinking and applications in its <a href="/manifesto" class="text-blue-500 hover:underline">manifesto</a>. 
    
</p> 
<p class="py-4">
ADP is the party for every Nigerian who believes that the traditional and archaic methods of attending to the Nigerian quagmire should be revisited . ADP is the political party that is building a better future for a more unified Nigeria.</p>
</div>
</section>
