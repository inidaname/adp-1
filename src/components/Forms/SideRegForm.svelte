  ...
  <h1 class="py-4 font-medium title-font sm:text-3xl text-2xl text-blue-900 ml-5 sm:ml-0">Member's Corner</h1>
    <div class="container px-5 py-10 mx-auto flex flex-wrap items-center">
      <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
        ...
        <p class="leading-relaxed mt-4">Whatever change you think you can bring to this great nation, you can always start with a step.</p>
      </div>
      <div class="lg:w-2/6 md:w-1/2 bg-gray-900 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
        <h2 class="text-gray-100 text-lg font-medium title-font mb-5">Sign In</h2>
        ...
        <p class="text-xs text-gray-500 mt-3"><a href="/register" class="text-blue-500">Register</a> for an account with us </p>
      </div>
    </div>
  </section>