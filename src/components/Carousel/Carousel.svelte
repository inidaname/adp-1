...
<section class="relative">
	<div class="">
        ...
        <div class="absolute top-0 right-0 left-0 flex w-screen md:px-5 bg-opacity-70 h-full justify-center bg-gray-900 md:flex-row items-center">
                <div class="lg:flex-grow md:w-1/2 max-w-lg mt-9 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center ">
                        <h1 class="title-font sm:text-4xl md:text-3xl text-lg mb-4 font-medium hidden  sm:block text-red-500 lg:text-5xl ">Action Democratic Party</h1>
